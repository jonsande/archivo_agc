...
class HomeConfig(models.Model):
    titulo = models.CharField(max_length=48, null=False, blank=False, default='Archivo de Tertulias de ¿Agustín García Calvo?')
    subtitulo = models.CharField(max_length=64, null=False, blank=False, default='Bienvenidos al Archivo de Tertulias de Agustín García Calvo')
